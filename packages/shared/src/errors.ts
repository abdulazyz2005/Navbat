...
export const ERROR_MESSAGES = {
  ...
  PAYMENT_CARD_NOT_SET: 'Platforma kartasi hali sozlanmagan. Admin bilan bog‘laning.',
  INTENT_NOT_FOUND: 'To‘lov so‘rovi topilmadi.',
  INTENT_EXPIRED: 'To‘lov so‘rovining muddati o‘tdi. Yangisini yarating.',
  INTENT_ALREADY_REVIEWED: 'Bu to‘lov allaqachon ko‘rib chiqilgan.',
  RECEIPT_REQUIRED: 'To‘lov chekini yuklang.',
  RECEIPT_TOO_LARGE: 'Chek rasmi juda katta (maksimum 2 MB).',
  INVALID_RECEIPT_FORMAT: 'Chek faqat rasm (JPEG/PNG) bo‘lishi kerak.',
  ACTIVE_INTENT_EXISTS: 'Sizda tasdiqlanmagan to‘lov bor. Avval uni yakunlang.',
  CARD_REQUIRED: 'Avval profilda karta raqamingizni saqlang.',
  INVALID_CARD: 'Karta raqami noto‘g‘ri (16 raqam bo‘lishi kerak).',
  ADMIN_CODE_INVALID: 'Kod noto‘g‘ri yoki muddati o‘tgan.',
  ADMIN_SESSION_REQUIRED: 'Admin panelga kirish uchun botdan /admin buyrug‘ini yuboring.',
